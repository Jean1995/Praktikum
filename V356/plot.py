...
xplot2 = np.linspace(60000, 73000, 100000)
plt.plot(0.001*xplot, 0.001*vph(2*np.pi*xplot), '-b', label='Theoriekurve: Phasengeschwindigkeit')
plt.plot(0.001*xplot2, 0.001*vph(2*np.pi*xplot2), '-b', label='Theoriekurve: Phasengeschwindigkeit')
plt.plot(0.001*c, 0.001*v_ph, 'xr', label='Abgelesene Werte')
plt.xlabel(r'$\nu \:/\: \si{\kilo\hertz} $')
plt.ylabel(r'$v_{\text{Ph}} \:/\: \si{\kilo\hertz}$')
plt.legend(loc='best')
plt.tight_layout(pad=0, h_pad=1.08, w_pad=1.08)
