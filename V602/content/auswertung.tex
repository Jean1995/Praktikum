...
\begin{align*}
  \sigma_{\text{K}_{\alpha}} &= \input{build/sigma_1_cu.tex} & \sigma_{\text{K}_{\alpha}, \text{lit}} &= \input{build/sigma_1_lit_cu.tex} \\
  \sigma_{\text{K}_{\beta}} &= \input{build/sigma_2_cu.tex} & \sigma_{\text{K}_{\beta}, \text{lit}} &= \input{build/sigma_2_lit_cu.tex}
\end{align*}
