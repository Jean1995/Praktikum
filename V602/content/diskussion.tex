...
\begin{align*}
  \increment E_{K_\alpha} &= \input{build/E_k_kante_a_rel_cu.tex} \\
  \increment E_{K_\beta} &= \input{build/E_k_kante_b_rel_cu.tex}
\end{align*}
...
\begin{align*}
  \increment E_{\text{max}} &= \input{build/E_max_rel.tex}
\end{align*}
ab.
...
\begin{align*}
  \increment \sigma_{1} &= \input{build/sigma_1_rel_cu.tex}, \\
  \increment \sigma_{2} &= \input{build/sigma_2_rel_cu.tex}, \\
  \increment \sigma_{3} &= \input{build/sigma_3_rel_cu.tex}.
\end{align*}
...
\begin{align*}
  \increment \sigma_{\text{Ge}} &= \input{build/sigma_ge_rel.tex}, \\
  \increment \sigma_{\text{Zr}} &= \input{build/sigma_zr_rel.tex}, \\
  \increment \sigma_{\text{Sr}} &= \input{build/sigma_sr_rel.tex}, \\
  \increment \sigma_{\text{Wi}} &= \input{build/sigma_wi_rel.tex}.
\end{align*}
Ebenso fehlerbehaftet ist die bestimmte Rydbergkonstante, welche vom Literaturwert \cite{Konstanten} mit
\begin{align*}
  \increment R_\infty &= \input{build/ebbergs_rel.tex},
\end{align*}
abweicht.
