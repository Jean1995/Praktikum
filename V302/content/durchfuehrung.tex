...
\begin{align}
   ...
   C  &= Wert3 = \SI{320}{\nano\farad}.
\end{align}
Die gemessenen Spannungen sind in \ref{tab:8} aufgetragen.
...
\end{equation}
Wird dieses Verhältnis in einem halblogarithmischen Zusammenhang dargestellt folgt das Diagramm \ref{fig:6}.
%\begin{equation}
%  \omega = 2 \pi v
%\end{equation}
