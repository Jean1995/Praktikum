...
\end{equation}
berechnet.
Dabei steht $\Delta l$ für die zusätzliche Wegstrecke der Lichtstrahlen und $N$ für die gezählten Maxima des Interferenzmusters, die den Detektor während der Verschiebung passieren.
...
\input{build/Tabelle_c_texformat.tex}
