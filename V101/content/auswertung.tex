...
Der gemittelte Wert für die Winkelrichtgröße lautet demnach
\begin{align*}
...
Mittels linearer Regression wird der Y-Achsen Abschnitt $b$ bestimmt.
...
Durch den Zusammenhang (\ref{eqn:zeiten}) und dem Satz von Steiner,
\begin{equation}
...
Das Ausmessen des Zylinders führt auf die Eckdaten
\begin{align*}
  R_{\text{Zylinder}} &= \input{build/r_zylinder.tex}, \\
  m_{\text{Zylinder}} &= \input{build/m_zylinder.tex}.
\end{align*}
Seine gemessene Umlaufzeit beträgt
\begin{align*}
  T_{\text{Zylinder}} = \input{build/t_zylinder.tex} \\
\end{align*}

Um sein theoretisches Trägheitsmoment zu bestimmen, wird die Formel für einen aufrechten sich drehenden Zylinder benutzt, welche
\begin{equation}
...
Aus der Gleichung (\ref{eqn:zeiten}) und nach dem Abziehen der Eigenrägheit folgt der gemessene Wert des Trägheitsmomentes zu
\begin{align*}
