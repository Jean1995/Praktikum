...
\end{equation}
\subsection{Der Schub- und Elastizitätsmodul}
...
\begin{figure}[H]
  ...
  \label{fig:2}
\end{figure}
Die Mantelfläche des Körpers schert sich nun unter einem Winkel $\alpha$. Diesen Sachverhalt verdeutlicht die Abbildung \ref{fig:3}.
\begin{figure}[H]
  \centering
